...
Version  : 1.7
Release  : 46
URL      : file:///insilications/build/clearlinux/packages/clazy/clazy-v1.7.tar.gz
Source0  : file:///insilications/build/clearlinux/packages/clazy/clazy-v1.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605744608
mkdir -p clr-build
pushd clr-build
