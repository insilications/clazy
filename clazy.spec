...
Version  : 1.9
Release  : 73
URL      : file:///aot/build/clearlinux/packages/clazy/clazy-v1.9.tar.gz
Source0  : file:///aot/build/clearlinux/packages/clazy/clazy-v1.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615150263
mkdir -p clr-build
pushd clr-build
...
export CXXFLAGS_GENERATE="-std=c++17 -O3 --param=lto-max-streaming-parallelism=16 -march=native -mtune=native -falign-functions=32 -flimit-function-alignment -fno-semantic-interposition -fno-stack-protector -fuse-ld=bfd -fuse-linker-plugin -malign-data=cacheline -mtls-dialect=gnu2 -fno-math-errno -fno-trapping-math -fvisibility-inlines-hidden -pipe -ffat-lto-objects -flto=16 -fPIC -pthread -static-libstdc++ -static-libgcc $PGO_GEN"
